...
from controllers.google_auth import router as google_auth_router
...
# Add simple server-side session support so controllers can store OAuth state
app.add_middleware(
    SessionMiddleware, secret_key=os.environ.get("SESSION_SECRET_KEY", "dev-secret-key")
)
